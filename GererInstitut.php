...
<body>
    ...
    <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Gerer Institut</h1>
    ...
    <div class="container">
        <div class="row">
            <div>
                <form action="GererInstitut.php" method="POST">
                    <input type="text" name="search" class="inputtbn">
                    <button class="btn btn-primary center rounded" type="submit"> Recherche</button>
                </form>
            </div>
            <div>
                <a href="AjouterInstitut.php"><button class="btn btn-primary"> Ajouter une institut </button></a>
            </div>

            <div>
                <thead>
                    <tr>
                        <th class="mx-4">nom</th>
                        <th class="mx-4">adresse</th>
                        >
                </thead>
            </div>
        </div>
